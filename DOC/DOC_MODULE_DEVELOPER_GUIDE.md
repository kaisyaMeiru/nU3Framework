...
[nU3ProgramInfo(
    typeof(PatientListControl),               // 컨트롤 타입
    "환자목록",                                // 화면 표시 이름
    "MOD_EMR_CL_PATIENT",                     // 모듈 ID
    "CHILD")]                                 // 모듈 타입 (자식 화면)
...
```csharp
// ✅ 올바른 예
public partial class PatientListControl : NuBaseControl  // NuBaseControl 상속
{
    // 필수 속성 구현
    public override string ScreenId => "EMR_CL_PATIENT_LIST_001";
...
// ✅ 대화상자 예
public partial class PatientSearchDialog : NuBaseForm  // NuBaseForm 상속
{
    public override string ScreenId => "EMR_CL_PATIENT_SEARCH_001";
...
// ❌ 잘못된 예 (상속하지 않음)
public partial class WrongPatientControl : UserControl  // 일반 UserControl 사용 안됨
{
    // nU3ProgramInfo 어트리뷰트를 사용해도 프레임워크에서 인식 불가
}
```
