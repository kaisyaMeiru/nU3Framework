...
* Shell이 2개 이상(멀티 프로세스) 실행될 경우, **Named Pipes** 또는 **gRPC** (Localhost)를 사용하여 메인 Shell과 서브 Shell 간의 환자 정보를 동기화해야 합니다.
...
현재 단계에서 가장 우선적으로 정해야 할 것은 **"통신 표준"**과 **"배포 구조"**입니다. 다음의 순서로 가이드를 구체화하시길 권장합니다.
